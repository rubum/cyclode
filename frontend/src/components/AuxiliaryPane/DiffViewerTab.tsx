          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center space-x-1.5 flex-1 min-w-0 overflow-hidden">
              ...
              <select
                ...
                className="bg-onedark-darker border border-onedark-border rounded px-2 py-1 text-xs text-onedark-fgBright outline-none focus:border-onedark-accent font-medium truncate w-full min-w-0 cursor-pointer"
              >
            ...
            {selectedPRNumber && (
              <div className="flex items-center space-x-1.5 flex-shrink-0 ml-1">
                <button
                  ...
                  disabled={isTesting}
                  className="px-2 py-1 rounded bg-onedark-accent/15 hover:bg-onedark-accent/25 text-onedark-accent border border-onedark-accent/30 text-[11px] font-semibold flex items-center space-x-1 transition-all disabled:opacity-50 cursor-pointer shadow-xs whitespace-nowrap"
                ...
                <button
                  ...
                  className="px-2 py-1 rounded bg-onedark-purple/15 hover:bg-onedark-purple/25 text-onedark-purple border border-onedark-purple/30 text-[11px] font-semibold flex items-center space-x-1 transition-all disabled:opacity-50 cursor-pointer shadow-xs whitespace-nowrap"
